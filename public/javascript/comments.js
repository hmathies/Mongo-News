...
function getComments() {
  ...
  $.getJSON("/all", function(data) {
    ...
    for (var i = 0; i < data.length; i++) {
      ...
      $("#comments").prepend("<p class='dataentry' data-id=" + data[i]._id + "><span class='dataComment' data-id=" +
        data[i]._id + ">" + data[i].comment + "</span><span class=deleter>X</span></p>");
    }
  });
}
...
//     .done(function(data) {
//       // Add the title and delete button to the #comments section
//       $("#comments").prepend("<p class='dataentry' data-id=" + data._id + "><span class='dataTitle' data-id=" +
...
//     dataType: "json",
//     url: "/clearall",
//     // On a successful call, clear the #comments section
...
//       $("#actionbutton").html("<button id='makenew'>Submit</button>");
//       // Grab the comments from the db again, to populate the DOM
//       getcomments();
//     }
//   });
// });